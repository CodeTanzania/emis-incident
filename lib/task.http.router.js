 ...
 * a task belongs.
 * @apiSuccess {Object} incident An incident under which a task is applicable.
 * @apiSuccess {Object} action An action under which a task is applicable.
 ...
 * @apiSuccess {Object} data.incident An incident under which a task is
 * applicable.
 * @apiSuccess {Object} data.action An action under which a task is applicable.
