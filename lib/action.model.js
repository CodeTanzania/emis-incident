 ...
 * @description prepare action seeding upsert criteria
 * @param {Object} seed plain object action seed
 * @return {Object} criteria used to upsert action
 *
 * @author lally elias <lallyelias87@gmail.com>
 * @since 1.5.0
 * @version 0.1.0
 * @public
 */
ActionSchema.statics.prepareSeedCriteria = seed => {
  // prepare action upsert criteria by _id or fields
