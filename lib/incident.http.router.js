...
router.get(PATH_LIST, function getIncidents(request, response, next) {
  ...
  Incident.get(options, function onGetIncidents(error, results) {
    // forward error
    if (error) {
      next(error);
    }
...
router.post(PATH_LIST, function postIncident(request, response, next) {
  ...
  Incident.post(body, function onPostIncident(error, created) {
    // forward error
    if (error) {
      next(error);
    }
...
router.get(PATH_SINGLE, function getIncident(request, response, next) {
  ...
  Incident.getById(options, function onGetIncident(error, found) {
    // forward error
    if (error) {
      next(error);
    }
...
router.patch(PATH_SINGLE, function patchIncident(request, response, next) {
  ...
  Incident.patch(id, patches, function onPatchIncident(error, patched) {
    // forward error
    if (error) {
      next(error);
    }
...
router.put(PATH_SINGLE, function putIncident(request, response, next) {
  ...
  Incident.put(id, updates, function onPutIncident(error, updated) {
    // forward error
    if (error) {
      next(error);
    }
...
router.delete(PATH_SINGLE, function deleteIncident(request, response, next) {
  ...
  Incident.patch(_id, patches, function onDeleteIncident(error, deleted) {
    //forward error
    if (error) {
      next(error);
    }
